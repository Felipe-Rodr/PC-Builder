...
const RegistrarPage = ({}:RegistrarPageProps) => {
    ...
    const RegistrarUsuario = trpc.useMutation(['user.registrarUser']);
    ...
    const handleChange = {
        ...
        handleConfirmarPasswordChange : (e:React.ChangeEvent<HTMLInputElement>) => {
    ...
    const handleKeydown = {
        ...
        handleConfirmarPasswordKeydown : (e:React.KeyboardEvent<HTMLInputElement>) => {
            if(e.key === 'ArrowUp'){
                PasswordRef.current?.focus()
            }
        }
            ...
            <div className='card flex-shrink-0 items-center w-full max-w-sm shadow-2xl bg-base-100'>
                ...
                <form className='form-control w-full max-w-xs' onSubmit={(e) => handleSubmit(e)}>
                    ...
                    <input 
                        ...
                        className='input input-bordered w-full max-w-ws'
                        onChange={(e) => handleChange.handleConfirmarPasswordChange(e)}
                        onKeyDown={(e) => handleKeydown.handleConfirmarPasswordKeydown(e)}
                    />
